...
rates are lower and Digital Brain uses neither today, so the standard rate is the one
...
them requires this kind of review for the scopes Digital Brain asks for.
