...
| 24       | Same-commit CI dependency, Compute/seed/rehearsal/graph checks, Vercel production promotion requirement                                              | Workflow contract tests and configured production deployment check; first release still to be verified                                                 |
